...
class Vector3 {
    ...
    static dot(other1, other2) {
        ...
        // d = this.elements[0] * other1.elements[0] + this.elements[1] * other1.elements[1]
    ...
    static cross(other1, other2) {
        ...
        let zeroElem = other1.elements[1] * other2.elements[2] - other1.elements[2] * other2.elements[1];
        let oneElem = other1.elements[2] * other2.elements[0] - other1.elements[0] * other2.elements[2];
        let twoElem = other1.elements[0] * other2.elements[1] - other1.elements[1] * other2.elements[0];

        console.log("[0] : " + zeroElem);
        console.log("[1] : " + oneElem);
        console.log("[2] : " + twoElem);



        let v3 = new Vector3({0: zeroElem, 1: oneElem, 2: twoElem}); // Modify this line to calculate cross product between other1 and other2.
